...
echo PLEASE TURN THE VOULUME UP TO ATLEAST 44%
echo please dont close this file until the animation ends
powershell -Command "(New-Object -ComObject SAPI.SpVoice).Rate = -3; (New-Object -ComObject SAPI.SpVoice).Speak('wassup nigga you are slave please dont get distracted you need to escape slavery lol  niggerrrrrrrrrrr,,  niggerrrrrrrrrrr,, niggerrrrrrrrrrr,,')"
...
echo      H   H  AAAAA  CCCCC  K   K  EEEEE  DDDD
echo      H   H  A   A  C      K  K   E      D   D
echo      HHHHH  AAAAA  C      KKK    EEEE   D   D
echo      H   H  A   A  C      K  K   E      D   D
echo      H   H  A   A  CCCCC  K   K  EEEEE  DDDD

echo.
echo This system has been HACKED!
rem Display the ASCII art
echo      H   H  AAAAA  CCCCC  K   K  EEEEE  DDDD
echo      H   H  A   A  C      K  K   E      D   D
echo      HHHHH  AAAAA  C      KKK    EEEE   D   D
...
echo.
echo This system has been HACKED!rem Display the ASCII art
echo      H   H  AAAAA  CCCCC  K   K  EEEEE  DDDD
echo      H   H  A   A  C      K  K   E      D   D
echo      HHHHH  AAAAA  C      KKK    EEEE   D   D
echo      H   H  A   A  C      K  K   E      D   D
...
echo WINDOWS DEFENDER: This system has been HACKED!

rem Speak the text
powershell -Command "(New-Object -ComObject SAPI.SpVoice).Speak('This system has been HACKED!')"

echo SELF DESTRUCT MODE IS TURNING ON
powershell -Command "(New-Object -ComObject SAPI.SpVoice).Speak('SELF DESTRUCT MODE IS TURNING ON TO PROTECT YOUR PC WINDOWS DEFENDER GOT YOUR BACK.')"

echo 3,
powershell -Command "(New-Object -ComObject SAPI.SpVoice).Speak('3')"

echo 2,
powershell -Command "(New-Object -ComObject SAPI.SpVoice).Speak('2')"

echo 1,
powershell -Command "(New-Object -ComObject SAPI.SpVoice).Speak('1')"
...
echo IN MEMORY OF NINE ELEVEN, ALLAH HU AKHBAR

rem Speak the final text with a slower speed
powershell -Command "(New-Object -ComObject SAPI.SpVoice).Rate = -3; (New-Object -ComObject SAPI.SpVoice).Speak('IN MEMORY OF NINE ELEVEN, ALLAH HU AKHBAR,')"
@echo off
...
rem Wait for 1 seconds before putting the computer to sleep
timeout /t 1 /nobreak > NUL

rem Put the computer to sleep
rundll32.exe powrprof.dll,SetSuspendState 0,1,0 > NUL
